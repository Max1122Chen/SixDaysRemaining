...
| 优先级 | 关联 | 状态 | 负责人 | 下一步行动 |
|--------|------|------|--------|-------------|
| P0 | **CORE-F10** 设计师反馈修复包 02 | Review | Max | 已实现；EditMode / 轻 Play 后 Done |
| P0 | **END-F02** 结局判定数据驱动（A–I） | Review | Max | 已合 main；F10 补 criteriaHint 展示 |
| P0 | **AUDIO-F01** 场景 BGM 接入 | Done | Max | 已合 main |
